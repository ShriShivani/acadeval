...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("role", postgresql.ENUM("student", "guide", "reviewer", "hod", name="userrole", create_type=False), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("submission_type", postgresql.ENUM("document", "video", "abstract", name="submissiontype", create_type=False), nullable=False),
        sa.Column("github_url", sa.String(500), nullable=True),
        sa.Column("related_submission_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("projects.id"), nullable=True),
        sa.Column("pipeline_status", postgresql.ENUM("uploaded", "ai_processing", "awaiting_review", "reviewed", name="pipelinestatus", create_type=False), nullable=False, server_default="uploaded"),
    ...
    op.create_table(
        ...
        sa.Column("status", postgresql.ENUM("pending", "under_review", "resolved", "rejected", name="appealstatus", create_type=False), nullable=False, server_default="pending"),
