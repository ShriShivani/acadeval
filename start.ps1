...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$Backend'; `$host.UI.RawUI.WindowTitle = 'AcadEval Backend'; .\venv\Scripts\uvicorn app.main:app --reload --port 8000"
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "Set-Location '$Backend'; `$host.UI.RawUI.WindowTitle = 'AcadEval Celery Beat'; .\venv\Scripts\celery -A app.worker beat --loglevel=info"
